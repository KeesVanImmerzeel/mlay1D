...
na_metzb <- readRDS('na/met zandbaan/Raai b na met zandbaan')
x <- 775
i <- which(na_metzb[1,]==x)
na_metzb_verhwrst <- readRDS('na/met zandbaan/met verhoogde weerstand tussen zandbaan en randsloot/Raai B na met zandbaan')

voor_metzb <- readRDS('voor/met zandbaan/Raai b voor met zandbaan')
voor_metzb_verhwrst <- readRDS('voor/met zandbaan/met verhoogde weerstand tussen zandbaan en randsloot/Raai b voor met zandbaan')
